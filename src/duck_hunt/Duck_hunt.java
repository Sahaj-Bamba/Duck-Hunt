...
public class Duck_hunt {
    ...
    public static Ducks Red = new Ducks(1.0,2.0,2,2,3,"On an island occupied by the cheeriest birds imaginable, Red is a bit of an outcast.\n His cynical outlook has kept him at odds with the other birds, \n but a bit of cynicism might be just what they need.","C:\\Users\\user\\Desktop\\Duck-Hunt\\Images\\Menu_1.jpg","The Red");
