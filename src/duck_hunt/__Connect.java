 ...
 * @author admin
 */
public class __Connect extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(__Connect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
