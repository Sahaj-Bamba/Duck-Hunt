 ...
 * @author admin
 */
public class Client_GUI extends javax.swing.JDialog {

    /**
     * Creates new form Client_GUI
     */
    public Client_GUI(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void start() {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Client_GUI dialog = new Client_GUI(new javax.swing.JFrame(), true);
